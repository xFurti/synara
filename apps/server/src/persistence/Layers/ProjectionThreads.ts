...
const ProjectionThreadDbRow = ProjectionThread.mapFields(
  Struct.assign({
    ...
    bakeoff: Schema.NullOr(Schema.fromJsonString(ThreadBakeoff)),
    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.bakeoff == null ? null : JSON.stringify(row.bakeoff)},
        ...
        DO UPDATE SET
          ...
          bakeoff_json = excluded.bakeoff_json,
